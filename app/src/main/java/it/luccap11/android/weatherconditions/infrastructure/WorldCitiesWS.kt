...
interface WorldCitiesWS {
    ...
    @GET("Continentscountriescities_City?count=1&limit=5&order=name,country&include=country&keys=name,country,country.name,country.continent,population,location,cityId")
